<?php
// --- BLOQUE DE SEGURIDAD ANTICACHÉ Y VALIDACIÓN ---
// Esto evita que el navegador guarde la "foto" de la página
...
// Expulsar si no hay sesión activa
                ...
                <?php if ($rol_usuario === 'super_admin'): ?>
                    <li class="bg-primary bg-opacity-10">
                        <a href="/servicio-comunitario/profesores/panel_super_admin.php" class="text-primary fw-bold">
                            <i class="fas fa-user-cog me-2"></i> Panel Super Admin
                        </a>
                    </li>
                <?php endif; ?>
                <li>
