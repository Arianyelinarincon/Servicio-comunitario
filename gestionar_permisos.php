...
if (isset($_GET['toggle_id'])) {
    ...
    $stmt = $conexion->prepare("UPDATE profesores SET permiso_editar_perfil = NOT permiso_editar_perfil WHERE id = ?");
...
$profesores = $conexion->query("SELECT id, nombre, telefono, direccion, permiso_editar_perfil FROM profesores");
?>
<!DOCTYPE html>
<html lang="es">
<head>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($row['telefono'] ?? '<em>No registrado</em>'); ?></td>
                    <td><?php echo htmlspecialchars($row['direccion'] ?? '<em>No registrado</em>'); ?></td>
                    <td>
