...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-header bg-navy text-white">
            <h5 class="mb-0"><i class="fas fa-user-plus me-2"></i>Agregar Profesor</h5>
        </div>
        <div class="card-body p-4">
            <?php if (isset($_GET['error'])): ?>
                ...
                <?php elseif ($_GET['error'] === 'cedula_duplicada'): ?>
                    <div class="alert alert-danger">Esta cédula ya está registrada.</div>
                <?php elseif ($_GET['error'] === 'db_error'): ?>
                    <div class="alert alert-danger">Error al guardar el profesor. Intente nuevamente.</div>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <form action="procesar_profesor.php" method="POST">
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-navy px-4"><i class="fas fa-save me-2"></i>Guardar</button>
