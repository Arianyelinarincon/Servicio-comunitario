...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Nomina de Alumnos Rendimiento Final</p>
        </div>
    </div>

    <div class="row g-4">
        <!-- Tarjeta: Estudiantes de Pre Inicial -->
        <div class="col-md-6 mb-4">
            <a href="pre-inicial.php" class="text-decoration-none">
                <div class="card p-4 dashboard-card text-center">
                    ...
                    <h5 class="fw-bold mt-3">Estudiantes de Pre Inicial</h5>
                    <p class="text-muted">Gestión y registro de alumnos de etapa preescolar</p>
                </div>
            </a>
        </div>
